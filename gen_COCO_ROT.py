...
#-------------------------------------------------
def main_gen_cocorot(out_dir, json_name_in, json_name_out, root_dir, img_path_dbg):
...
if __name__=='__main__':
    ...
    main_gen_cocorot(img_path, json_name_in, json_name_out, root_dir, img_path_dbg)
